            ...
            <div class="navigation">
                ...
                <div class="right-buttons">
                    <div class="remove-button">
                        <a href="acceptDelivery?orderId=<%=penDelOrder.getPendingDelivery().getOrderId()%>"><p>Accept</p></a>
                    </div>
                </div>
            </div>
            <div class="main-component">
                ...
                <div class="book-details">
                    ...
                    <div class="book-details-field">
                        ...
                        <p><%=penDelOrder.getPendingDelivery().getHouseNo()%></p>
                    </div>

                    <div class="book-details-field">
                        <p><strong>Street</strong></p>
                        <p><%=penDelOrder.getPendingDelivery().getStreet()%></p>
                    </div>

                    <div class="book-details-field">
                        <p><strong>City</strong></p>
                        <p><%=penDelOrder.getPendingDelivery().getCity()%></p>
                    </div>

                    <div class="book-details-field">
                        <p><strong>District</strong></p>
                        <p><%=penDelOrder.getPendingDelivery().getDistrict()%></p>
                    </div>

                    <div class="book-details-field">
                        <p><strong>Province</strong></p>
                        <p><%=penDelOrder.getPendingDelivery().getProvince()%></p>
                    </div>
                </div>
            </div>
