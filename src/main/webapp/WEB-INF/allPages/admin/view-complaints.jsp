    ...
    <main>
        <div class="main__container">
            <div class="table-template view-seller-applications">
                <div class="head">
                    <h2 class="title">View Complaints</h2>
                    <p class="description">View complaints made by users and respond to them.</p>
                </div>
                ...
                <table>
                    ...
                    <tr class="table-rows">
                        ...
                        <td class="table-cell">
                            <p class="field-name"><strong>Title</strong></p>
                            <p><strong>Website not working</strong></p>
                        </td>

                        <td class="table-cell">
                            <div class="view-more-button">
                                <a href="<%=MyVariables.rootURL%>admin/viewComplaintsMore"><h2>View</h2></a>
                            </div>
                        </td>
                    </tr>
