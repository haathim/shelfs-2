...
<head>
    ...
    <link rel="stylesheet" href="../allPages/delivery/New/pickupHistory.css">
...
<%
    ArrayList<NewOrderPickups> historyPickups = (ArrayList<NewOrderPickups>) request.getAttribute("historyPickups");
%>
...
<%--            </div>--%>
    ...
    <main>
        <div class="table-container">
            <h1 class="heading">Pickup History</h1>
            <table class="table">
                <thead>
                <tr>
                    <th>Pickup ID</th>
                ...
                <tbody>
                <% for (NewOrderPickups pickup: historyPickups){%>
                <tr>
                    <td data-label="Start Date"><%=pickup.getPickupId()%></td>
                    <td data-label="Start Date"><%=pickup.getSellerId()%></td>
                    <td data-label="Start Date"><%=pickup.getOrderId()%></td>
                    <td data-label="Buttons"><a href="pendingPickupAllDetailsNew?pickupId=<%=pickup.getPickupId()%>" class="btn">See more</a></td>
                </tr>
                <%}%>
                </tbody>
            </table>
