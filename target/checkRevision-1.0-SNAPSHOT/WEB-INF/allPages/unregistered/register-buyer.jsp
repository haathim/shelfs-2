          ...
          <div class="buyer-register">
            <div class="formContainer">
              ...
              <div id="instructions" style="color: blue; font-weight: bold">
                <p>
                  Username: Use only letters and digits. Length 3 - 20. Should
                  be globally unique.
                </p>
                <p>
                  First Name, Last Name: Use only letters. First letter should
                  be Capital. Length 3 - 20.
                </p>
                <p>Password: Length 8 - 20.</p>
                <p>House Number: Use only letters and digits. Length 1 - 20.</p>
                <p>
                  Street, City: Use only letters and spaces. Length 5 -
                  20(including spaces).
                </p>
                <p>
                  Mobile No: Should be valid SriLankan mobile number. Eg:
                  0777123456
                </p>
                <p>Email: Should be valid email. Should be globally unique.</p>
              </div>
              ...
              <form action="buyerRegSubmit" method="post" id="form">
                ...
                <div class="row">
                  <div class="column">
                    ...
                    <input id="houseNo" type="text" name="houseNo" required />
                  </div>
                </div>
                <div class="row">
                  <div class="column">
                ...
                <div class="row">
                  <div class="column">
                    ...
                    <input id="mobileNo" type="text" name="mobileNo" required />
                  </div>
                  <div class="column">
