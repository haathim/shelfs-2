...
@WebServlet(name = "salesHistoryMoreServlet", value = "/seller/salesHistoryMore")
public class salesHistoryMoreServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            OrderAdCombined orderAd = dao.getOrderByIdForSeller(orderId, sellerId);
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/allPages/seller/sales-history-more.jsp");
