...
//
//@WebServlet(name = "requestBooksSellerServlet", value = "/seller/requestBooks")
//public class requestBooksSellerServlet extends HttpServlet {
//    @Override
//    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
//
//        RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/allPages/seller/request-book-form.jsp");
