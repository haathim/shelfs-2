          ...
          <div class="main-area-box">
              <div class="top-box-block">
                  <div class="top-box-title-block">
                      ...
                      <div class="top-box-checkout-block">
...
<%--                              <i class="fa fa-book">--%>
                                  <form action="testPayHereServlet" method="post">
                                      ...
                                      <button type="submit" id="chkout-btn">Proceed to checkout</button>
                                  </form>
<%--                              </i>--%>
                          </div>
                      </div>
...
<%--                <img src="../allPages/uploads/hobbit-cover.jpg" alt="Book Cover" />--%>
<%--                <p>The Hobbit</p>--%>
<%--              </td>--%>
...
<%--            <tr class="table-rows">--%>
<%--              <td class="table-cell product">--%>
<%--                <img src="../allPages/uploads/aw80-cover.jpg" alt="Book Cover" />--%>
<%--                <p>The Hobbit</p>--%>
<%--              </td>--%>
...
<%--            <tr class="table-rows">--%>
<%--              <td class="table-cell product">--%>
<%--                <img src="../allPages/uploads/got-cover.jpg" alt="Book Cover" />--%>
<%--                <p>The Hobbit</p>--%>
<%--              </td>--%>
...
<%--            <tr class="table-rows">--%>
<%--              <td class="table-cell product">--%>
<%--                <img src="../allPages/uploads/sherlock-cover.jpg" alt="Book Cover" />--%>
<%--                <p>The Hobbit</p>--%>
<%--              </td>--%>
