...
<%--  <link rel="stylesheet" href="../allPages/buyer/sidebar.css" />--%>
  <link rel="stylesheet" href="../allPages/delivery/pendingDelivery.css">
...
<body id="body">
<%
  ArrayList<PenDelOrderCombined> penDelOrderCombineds = (ArrayList<PenDelOrderCombined>) request.getAttribute("pendingDeliveries");
%>
<div class="container">
    ...
    <div class="pending-delivery">
      ...
      <% for (PenDelOrderCombined penDel : penDelOrderCombineds){%>
        ...
        <div class="section-3">
          ...
          <a href="updateDelivery?orderId=<%=penDel.getOrder().getOrderId()%>"><button class="button button-3">UPDATE STATUS</button></a>
        </div>
...
<%--          </div>--%>
<%--          <div class="buyer-details">--%>
<%--            <h3>Buyer name <span style="color:white;"> Asitha Muthumala</span></h3>--%>
